...
export class Menu {
  ...
  async SelectItem (page:any,item:string) {
      ...
      //await expect (BurgerNameLocatorInMenu).toHaveText(/SMOKED BRISKET BACON SMASH/i);
      //const burgername = await page.locator('//*[@id="__next"]/div[2]/main/div[2]/div/div/form/div[1]/h1').innerText();
